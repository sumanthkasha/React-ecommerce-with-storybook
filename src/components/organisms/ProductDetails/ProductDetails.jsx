...
export default function ProductDetails() {
    ...
    const ProductDescription = (product) => {
        return (
            <div className="product-details__container d-flex flex-column">
                <Link
                    to={`/collections/${params.productType}`}
                ...
                <section className="product-details__wrapper">
                    <div className="product-image">
                        <ImageCmp src={product.image} alt={product.brand_name} />
                    </div>
                    <div className="product-info">
                        ...
                        <span className="product__price">
                            <span>&#8377;</span> {product.price.toString()}
                        </span>
                        <h3 className="product__mrp-wrapper">
                            M.R.P.:
                            <span className="product__mrp">
                                &#8377; {calculateActualPrice( product.price, product.discount.slice(0, 1))}
                            </span>
                        </h3>
                        ...
                        >
                            {
                                wishlistData[product.id.toString()] === "remove" || !wishlistData[product.id]
                                ? (
                                    <CiHeart />
                                ) 
                                : (
                        ...
                        {
                            cartData[product.id.toString()] === "remove" || !cartData[product.id] 
                            ? (
                                <Button
  ...
  return (
    <section>
        {
            data && ProductDescription(data.find((element) => 
